	...
	<div id="nav-fixed">
		<div class="container">
			...
			<ul class="nav-menu nav navbar-nav">
				...
				<li class="cat-1"><a href="{{ route('articles') }}">Гостиная</a></li>
				<li class="cat-2"><a href="{{ route('articles') }}">Спальня</a></li>
				<li class="cat-3"><a href="{{ route('articles') }}">Кухня</a></li>
				<li class="cat-4"><a href="{{ route('articles') }}">Ванная</a></li>
